...
class BookingControllerTest {
    ...
    void createBooking() throws Exception {
        ...
        assertThat(performCreateBooking(userId, itemId, start, LocalDateTime.now().minusYears(1)).getStatus(), is(400));
    }
    ...
    void getBookingsByState() throws Exception {
        ...
        assertThat(performGetBookingsByState(userId, null).getStatus(), is(200));
        verify(bookingService, times(1)).getBookingsForUser(userId, BookingState.ALL, 0, 10);

        assertThat(performGetBookingsByState(userId, -1, 11, BookingState.CURRENT.toString()).getStatus(), is(400));
        assertThat(performGetBookingsByState(userId, 0, -1, BookingState.PAST.toString()).getStatus(), is(400));
    }
    ...
    void getBookingsByStateOwner() throws Exception {
        ...
        assertThat(performGetBookingsByStateOwner(userId, null).getStatus(), is(200));
        verify(bookingService, times(1)).getBookingsForItemOwner(userId, BookingState.ALL, 0, 10);

        assertThat(performGetBookingsByStateOwner(userId, -1, 11, BookingState.CURRENT.toString()).getStatus(), is(400));
        assertThat(performGetBookingsByStateOwner(userId, 0, -1, BookingState.PAST.toString()).getStatus(), is(400));
    }

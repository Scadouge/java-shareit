...
class GetBookingsForUserAndItemOwnerTest {
    ...
    void setUp() {
        ...
        futureRejectedBooking = bookingService.createBooking(new CreateBookingArgs(itemByOwner2.getId(), LocalDateTime.now().plusMinutes(10), LocalDateTime.now().plusMinutes(10).plusDays(1), booker.getId()));
        bookingService.updateBookingStatus(owner2.getId(), futureRejectedBooking.getId(), false);

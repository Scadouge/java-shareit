...
class RequestControllerTest {
    ...
    void getOwnRequests() throws Exception {
        ...
        assertThat(performGetOwnRequests(userId).getStatus(), is(200));
        verify(requestService, times(1)).getOwnRequests(userId, 0, 10);

        assertThat(performGetOwnRequests(userId, -1, 11).getStatus(), is(400));
        verify(requestService, times(0)).getOwnRequests(userId, -1, 11);

        assertThat(performGetOwnRequests(userId, 0, -1).getStatus(), is(400));
        verify(requestService, times(0)).getOwnRequests(userId, 0, -1);
    }
    ...
    void getAllRequests() throws Exception {
        ...
        assertThat(performGetAllRequests(userId).getStatus(), is(200));
        verify(requestService, times(1)).getAllRequests(userId, 0, 10);

        assertThat(performGetAllRequests(userId, -1, 11).getStatus(), is(400));
        verify(requestService, times(0)).getAllRequests(userId, -1, 11);

        assertThat(performGetAllRequests(userId, 0, -1).getStatus(), is(400));
        verify(requestService, times(0)).getAllRequests(userId, 0, -1);
    }

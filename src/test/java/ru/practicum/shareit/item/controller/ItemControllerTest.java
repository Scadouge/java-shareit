...
class ItemControllerTest {
    ...
    void createItem() throws Exception {
        ...
        assertThat(performCreateItem(userId, "Name", "Desc", null).getStatus(), is(400));
    }
    ...
    void getAllUserItems() throws Exception {
        ...
        assertThat(performGetAllUserItems(userId).getStatus(), is(200));
        verify(itemService, times(1)).getAll(userId, 0, 10);

        assertThat(performGetAllUserItems(userId, 0, -1).getStatus(), is(400));
        assertThat(performGetAllUserItems(userId, -1, 11).getStatus(), is(400));
    }

...
public class BookingController {
    ...
    @GetMapping
    public Collection<BookingDto> getBookingsByState(@RequestParam(defaultValue = "0") @PositiveOrZero Integer from,
    ...
    @GetMapping("/owner")
    public Collection<BookingDto> getBookingsByStateOwner(@RequestParam(defaultValue = "0") @PositiveOrZero Integer from,
                                                          @RequestParam(defaultValue = "10") @Positive Integer size,
                                                          @RequestHeader(Headers.HEADER_USER_ID) Long userId,
                                                          @RequestParam(required = false) String state) {

...
public class RequestController {
    ...
    @GetMapping
    Collection<RequestWithItemInfoDto> getOwnRequests(@RequestParam(defaultValue = "0") @PositiveOrZero Integer from,
    ...
    @GetMapping("/all")
    Collection<RequestWithItemInfoDto> getAllRequests(@RequestParam(defaultValue = "0") @PositiveOrZero Integer from,
                                                      @RequestParam(defaultValue = "10") @Positive Integer size,
                                                      @RequestHeader(Headers.HEADER_USER_ID) Long userId) {

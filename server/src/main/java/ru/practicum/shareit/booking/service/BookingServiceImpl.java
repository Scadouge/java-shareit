...
public class BookingServiceImpl implements BookingService {
    ...
    public Map<Long, List<Booking>> getItemLastBookingMapping(Set<Long> itemIds) {
        ...
        lastBookingMapping = bookingRepository.findLastBookingWithStatus(itemIds, now, BookingStatus.APPROVED)
    ...
    public Map<Long, List<Booking>> getItemNextBookingMapping(Set<Long> itemIds) {
        ...
        nextBookingMapping = bookingRepository.findNextBookingWithStatus(itemIds, now, BookingStatus.APPROVED).stream()
